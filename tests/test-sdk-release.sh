...
grep -Fxq "Platform Version = 2.1.2" "${branch_release}"
grep -Fxq "Platform Base = 2.1.2" "${branch_release}"
...
grep -Fxq "Neat Core = not bundled" "${branch_release}"
...
grep -Fxq "SDK Release = v2.1.2" "${tag_release}"
...
grep -Fxq "Neat Core = not bundled" "${tag_release}"
grep -Fxq "ROS2 SDK Version = v2.1.2" "${tag_release}"
